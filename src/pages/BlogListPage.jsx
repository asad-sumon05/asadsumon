...
export default function BlogListPage() {
  ...
  return (
    <div className="mt-28 mb-20 min-h-[60vh]">
      <SEOHead
        title="Blog | Asaduzzaman Sumon — Articles on Testing, Development & Tech"
        description="Read the latest articles on web development, software testing, React, and tech roadmaps by Asaduzzaman Sumon. In-depth guides for developers and QA engineers."
        canonicalPath="/blog"
      />
      ...
      <motion.div {...fadeUp(0.3)} className="px-5 lg:px-28 mt-16 lg:mt-20">
        <div className="rounded-2xl border border-black/8 p-6 lg:p-10 text-center">
          ...
          <div className="mt-5 flex justify-center gap-3">
            ...
            <a
              href="https://linkedin.com/in/asadsumon"
              target="_blank"
              rel="noopener noreferrer"
