...
export default function BlogPostPage() {
  ...
  return (
    <div className="mt-28 mb-20 min-h-[60vh]">
      <SEOHead
        title={`${blog.title} | Asaduzzaman Sumon`}
        description={blog.summary}
        keywords={`${blog.title}, Asaduzzaman Sumon blog, ${blog.category}, asadsumon`}
      ...
      <motion.header {...fadeUp(0.05)} className="px-5 lg:px-28 mb-12 lg:mb-16 pb-8 lg:pb-10 border-b border-black/8">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mt-8">
            ...
            <div>
              <p className="text-sm font-medium text-black">Asaduzzaman Sumon</p>
      ...
      <motion.div {...fadeUp(0.2)} className="px-5 lg:px-28 mt-8 mb-12">
        <div className="max-w-3xl rounded-2xl border border-black/8 p-6 lg:p-8 flex flex-col sm:flex-row items-start gap-5">
          ...
          <div>
            <p className="text-base font-medium text-black mb-1">Written by Asaduzzaman Sumon</p>
            ...
            <div className="flex gap-3">
              <a href="https://github.com/asad-sumon05" target="_blank" rel="noopener noreferrer" className="text-xs px-3 py-1.5 border border-black/15 rounded-md hover:bg-black hover:text-white transition-all duration-300">GitHub</a>
              <a href="https://linkedin.com/in/asadsumon" target="_blank" rel="noopener noreferrer" className="text-xs px-3 py-1.5 border border-black/15 rounded-md hover:bg-black hover:text-white transition-all duration-300">LinkedIn</a>
            </div>
          </div>
        </div>
      </motion.div>
