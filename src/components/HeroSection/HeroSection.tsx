        ...
        >
          ...
          >
            ...
            <div className="block dark:hidden">
              <span className="bg-gradient-to-r from-violet-600 via-sky-500 via-purple-600 to-indigo-600 bg-clip-text text-transparent font-extrabold text-[clamp(2rem,5vw,4.5rem)] leading-none tracking-tight block pb-2 select-none">
                {personalInfo.name}
              </span>
            </div>
          ...
          >
            {personalInfo.title} — building modern web applications, scalable APIs, and exceptional digital experiences.
          </motion.p>
          ...
          >
            ...
            <a href={personalInfo.resume} download="Asaduzzaman_Sumon_Resume.pdf">
          ...
          >
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs font-bold text-muted-foreground hover:text-foreground transition-colors tracking-wider uppercase border border-foreground/15 hover:border-primary/50 rounded-lg px-3 py-1.5 hover:-translate-y-0.5 transform duration-200"
              >
                {label}
              </a>
            ))}
          ...
          >
            <div className="flex flex-col h-full bg-card w-full">
              ...
              <div className="relative px-5 pt-7 pb-6 flex flex-col items-center bg-gradient-to-br from-purple-700 via-primary to-indigo-950 text-white overflow-hidden">
                ...
                {/* Profile Photo */}
                <div className="mt-1 relative w-28 h-28 rounded-full p-1 bg-gradient-to-tr from-cyan-400 via-primary to-purple-400 backdrop-blur-md shadow-2xl border border-white/50 overflow-hidden">
                  <img
                    src={images.profile}
              ...
              <div className="p-5 flex flex-col items-center text-center bg-card text-card-foreground flex-1 gap-3">
                <div>
                  <h3 className="text-xl font-extrabold tracking-tight text-foreground">{personalInfo.name}</h3>
                ...
                <div className="grid grid-cols-2 gap-2.5 w-full text-left bg-muted/40 p-3 rounded-xl border border-border/50">
                  <div>
                    ...
                    <span className="font-bold text-foreground text-xs">Full-Stack & UI</span>
                  </div>
                  <div>
                ...
                <div className="flex flex-col items-center mt-1 w-full gap-1">
                  ...
                  <div className="flex items-center justify-between w-full px-1 text-[10px]">
                    <span className="font-mono font-bold tracking-widest text-primary">AS-2025-DEV</span>
                    <span className="text-muted-foreground font-semibold text-[9px] uppercase tracking-wider">PORTFOLIO</span>
                  </div>
                </div>
              </div>
            </div>
