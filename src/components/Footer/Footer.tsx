          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social, i) => (
              <a
                ...
                title={social.label}
                className="w-9 h-9 rounded-full glass-panel border border-black/10 dark:border-white/10 flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/40 hover:scale-110 transition-all shadow-sm"
              >
