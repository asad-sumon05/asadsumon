...
export default function Loader({ onLoadComplete }) {
  ...
  return (
    <AnimatePresence>
      {!isComplete && (
        <motion.div
          className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-white dark:bg-[#111] text-[#111] dark:text-white font-sans transition-colors duration-300"
          initial={{ y: 0 }}
